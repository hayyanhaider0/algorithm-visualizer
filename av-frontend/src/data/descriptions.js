const descriptions = {
  linkedList: {
    paragraphs: [
      ...
      "Singly Linked List: In a singly linked list, each node contains a pointer to the next node, and traversal is done in one direction—from the head to the tail.",
